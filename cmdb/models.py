...
class Asset(models.Model):
    ...
    admin = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, verbose_name='资产管理员',
                              related_name='admin')
    ...
    approved_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, verbose_name='批准人',
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, verbose_name='事件执行人',
